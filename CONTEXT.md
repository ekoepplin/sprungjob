...
**Job**:
A job posting fetched live from Bundesagentur für Arbeit's Jobsuche service, via an interface BA has publicly stated is not intended for third-party automated use. Sprungjob does not create, own, or have a licensed right to this data.
